...
//		add_action( 'delete_post', array( $this, 'remove_custom_page' ), 10 );
	...
	function settings_page_setup(){
		...
		if ( !empty( $settings_page ) ) {
			...
			// add_filter( 'screen_layout_columns', array($this, 'ls_screen_layout_column'), 10, 2 );
	...
	function page_added_notice() {
		...
		<div id="message" class="updated notice is-dismissible">
			<p>
				<?php _e('A <a href="'. $custom_payment_page .'">new contact us page</a> was added to your site.','livesite'); ?>
				<br>
				<?php _e('Customize your contact form and add it to any other page <a href="'. $module_url .'">here</a>.','livesite'); ?>
			</p>
		</div>
		<?php
	}
		...
		<div class="wrap">
			...
			<div class="ls-module-page-title">
				...
				<div class="ls-module-page-title__title-wrapper">
					<strong class="ls-module-page-title__heading"><?php _e('LiveSite Form Builder','livesite'); ?></strong>
	...
	?>
		...
		<table class="form-table">
			<tr>
				<td> <?php _e('Contact Us page','livesite'); ?></td>
				<td>
	...
	?>
		...
		<a href="https://www.vcita.com/account/upgrade?<?php echo $ls_helpers->get_plugin_identifier(); ?>_Form-builder" target="_blank" class="button button-primary">
			<?php _e('Try vCita Permium','livesite'); ?>
		</a>
