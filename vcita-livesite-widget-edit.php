...
<div class="vcita-wrap wide">
	...
	<a class="left faq" href="http://support.vcita.com/forums/21650943-wordpress" target="_blank">Add LiveSite Widget on specific pages</a>
	...
	<script type="text/html" id="iframe-template">
		<iframe src="http://<?php echo VCITA_SERVER_BASE ?>/widget_implementations?platform=wordpress&widget=active_engage&key=<?php echo $key ?>" width="100%" height="100%"/>
	</script>
	<?php } else { ?>
	<script type="text/javascript">	
		jQuery(function ($) {	
